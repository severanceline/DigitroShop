...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20260519092400_AddShoppinhCart")]
    partial class AddShoppinhCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Domain.Entities.Cart.ShoppingCart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Store.Domain.Entities.Cart.ShoppingCartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Store.Domain.Entities.Cart.ShoppingCart", b =>
                {
                    b.HasOne("Store.Domain.Entities.Users.User", "User")
                        ...
                        .HasForeignKey("Store.Domain.Entities.Cart.ShoppingCart", "UserId")
            ...
            modelBuilder.Entity("Store.Domain.Entities.Cart.ShoppingCartItem", b =>
                {
                    ...
                    b.HasOne("Store.Domain.Entities.Cart.ShoppingCart", "ShoppingCart")
                        .WithMany("ShoppingCartItem")
